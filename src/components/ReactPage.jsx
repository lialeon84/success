        ...
        <div className="blog-post-intro">
            ...
            <p>It's very important to note that you should already have some basic knowledge of HTML, CSS and JavaScript.
                ...
                <p>In your VS Code open your terminal. In the terminal we're going to create the folder you're going to create your React app in.
                    ...
                    name, whatever it is that you've named your computer. For example, for Mac users it should be something like this:
                    
                    <pre rel="JavaScript" data-line> 
                      <code markup="tt">
                       userComputerName-MacBook-Pro:~ userComputerName$
                      </code>
                  </pre> in your terminal. It's very important you have a dollar sign at the end. It should be set 
                ...
                <p>Once you see your computer name you can create your folder for your React project. Here in this folder you will also put all of 
                    ...
                    coding-projects. You can name your folder the same as mine if you like. In your terminal type the following command:
                    <pre rel="JavaScript" data-line> 
                     <code markup="tt">
                        mkdir yourFolderNameHere
                     </code>
                    </pre> and press enter. Then cd into your folder by typing in the following command in your terminal:  
                    <pre rel="JavaScript" data-line> 
                     <code markup="tt">
                        cd yourFolderNameHere
                     </code>
                    </pre> and it will switch you into your fold. Now that you're in your project folder you can create your 
                    ...
                    <p>In your terminal and you should also be already be in your project folder once you've cd into it,
                         you're going to create a new folder that will only be for that React project. In your terminal type the following command:
                        <pre rel="JavaScript" data-line> 
                     <code markup="tt">
                        npx create-react-app nameYourReactProjectHere
                     </code>
                    </pre> In the (nameYourReactProjectHere) you can name your React project whatever you like (for example, I named mine coderchic) 
                    ...
                    <p>Let's cd into your React project. In your terminal type the following command:
                    <pre rel="JavaScript" data-line> 
                     <code markup="tt">
                        cd yourReactProjectNameHere
                     </code>
                    </pre>Once you have cd into your React folder you'll be able to see all of the folders that were 
                    created and start modifying your app.
                     </p>

                    <p>To start your React app simply type the following command in your terminal:
                    <pre rel="JavaScript" data-line> 
                    <code markup="tt">
                        npm start
                    </code>
                    </pre> It will open a web browser with the React logo.
                    </p>

                    <p>To quit your React app simply click in your terminal with the following:
                    <pre rel="JavaScript" data-line> 
                    <code markup="tt">
                        control c
                    </code>
                    </pre> It will stop your React app and you can close the browser. To restart your React app use the 
                    same command we used earlier above to start it. To save changes to your files, on your keyboard press: 
                    <pre rel="JavaScript" data-line> 
                    <code markup="tt">
                        control s
                    </code>
                    </pre> in your VS Code and you're all set. These are a few of the basic steps to start your first React project. To learn more 
